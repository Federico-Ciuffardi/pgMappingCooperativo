...
# this was abandoned, the one used was log_digester.py
...
for this_log in os.scandir(log_dir):
    ...
    # get map info
    real_map_path     = f"{maps_dir}/{map_name}/{cell_size_to_map_name(cell_size)}"
    ...
    explored_area = explored_cells/cell_size_2_cells_per_meter(cell_size) 
    ...
    erroneous_area = erroneous_cells/cell_size_2_cells_per_meter(cell_size)
    set_predigest_value(predigest, x_value, "erroneous_area", erroneous_area)

    # set the map_completeness in the predigest
    real_area = real_cells/cell_size_2_cells_per_meter(cell_size)
    ...
    # set_predigest_value(predigest, x_value, "info_ob_mean", predigest["auction_info_time_mean"][x_value][-1] - predigest["gvd_construction_time_mean"][x_value][-1] )
    # set_predigest_value(predigest, x_value, "info_ob_sum",  predigest["auction_info_time_sum"][x_value][-1] - predigest["gvd_construction_time_sum"][x_value][-1] )
    ...
    # set_predigest_value(predigest, x_value, "info_ob_percent_mean",  100 - predigest["gvd_update_auction_info_percent_log_mean"][x_value][-1] )
